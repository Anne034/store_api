...
api_router.include_router(categorias, prefix='/atletas', tags=['categorias/'])
api_router.include_router(categorias, prefix='/centro_treinamento', tags=['centro_treinamento/'])
